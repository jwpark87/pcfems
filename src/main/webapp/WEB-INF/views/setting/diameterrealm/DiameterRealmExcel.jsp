<%----------------------------------------------------------------------------------------
 - 파일이름	: setting/diameterrealm/Excel.jsp
 - 설      명	: Diameter Realm 관리 엑셀 업로드  page 
 - 추가내용	:
 - 버전관리	: 1.0
 ----------------------------------------------------------
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">
                <spring:message code="TEXT.SETTING.DIAMETER.REALM.SUBTITLE_EXCEL.DIAMETER_REALM_DETAIL"/>
            </h4>
        </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-md-2 control-label">
                                <spring:message code="TEXT.SETTING.DIAMETER.REALM.DETAIL.EXCEL.FILE_SEL"/>
                            </label>
                            <div class="col-md-10">
                ...
                <fieldset style="margin: 10px 0 0 0;">
                    <div class="row">
                        <div id="info-block" class="alert alert-info fade in" style="display: none;">
                            <i class="fa-fw fa fa-info" style="float: left; margin-top: 3px;"></i>
                            <span class="help-block-m" style="display: block; word-wrap: break-word;">
        ...
        $("#btnSubmit").on('click', function (event) {
            ...
            Pace.track(function () {
                ...
                $.ajax({
                    ...
                    url: '${CONTEXT_PATH}/setting/diameter/diameterrealmexcelpop.pop?actionID=ACTION_DIAMETER_REALM_EXCEL_UPLOAD_OK',
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
