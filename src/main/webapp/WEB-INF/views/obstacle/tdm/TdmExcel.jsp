<%----------------------------------------------------------------------------------------
 - 파일이름	: obstacle/tdm/Excel.jsp
 - 설      명	: Tdm 현황 엑셀 업로드  page 
 - 추가내용	:
 - 버전관리	: 1.0
 ----------------------------------------------------------
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">
                <spring:message code="TEXT.OBSTACLE.TDM.SUBTITLE_EXCEL.TDM_DETAIL"/>
            </h4>
        </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-md-2 control-label">
                                <spring:message code="TEXT.OBSTACLE.TDM.DETAIL.EXCEL.FILE_SEL"/>
                            </label>
                            <div class="col-md-10">
    ...
    $(document).ready(function () {
        ...
        $("#files").on('change', function () {
            ...
            if ($.inArray($(this).val().split('.').pop().toLowerCase(), fileExtension) == -1) {
                $("#files").val("");
                AotSmartAdmin.smallBoxsuccess("<spring:message code="MSG.ALERT.FILE_EXTENSION.FIRST" />" + fileExtension.join(', ') + "<spring:message code="MSG.ALERT.FILE_EXTENSION.END" />");
            }
        });
        ...
        $("#btnSubmit").on('click', function (event) {
            ...
            Pace.track(function () {
                ...
                $.ajax({
                    ...
                    url: '${CONTEXT_PATH}/obstacle/tdm/tdmexcelpop.pop?actionID=ACTION_TDM_EXCEL_UPLOAD_OK',
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
