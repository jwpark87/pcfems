<%----------------------------------------------------------------------------------------
 - 파일이름	: obstacle/link/Excel.jsp
 - 설      명	: Link 현황 엑셀 업로드  page 
 - 추가내용	:
 - 버전관리	: 1.0
 ----------------------------------------------------------
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">
                <spring:message code="TEXT.OBSTACLE.LINK.SUBTITLE_EXCEL.LINK_DETAIL"/>
            </h4>
        </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-md-2 control-label">
                                <spring:message code="TEXT.OBSTACLE.LINK.DETAIL.EXCEL.FILE_SEL"/>
                            </label>
                            <div class="col-md-10">
        ...
        $("#btnSubmit").on('click', function (event) {
            ...
            Pace.track(function () {
                ...
                $.ajax({
                    ...
                    url: '${CONTEXT_PATH}/obstacle/link/linkexcelpop.pop?actionID=ACTION_LINK_EXCEL_UPLOAD_OK',
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
