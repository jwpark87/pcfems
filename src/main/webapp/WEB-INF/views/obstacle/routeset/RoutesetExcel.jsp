<%----------------------------------------------------------------------------------------
 - 파일이름	: obstacle/routeset/Excel.jsp
 - 설      명	: Routeset 현황 엑셀 업로드  page 
 - 추가내용	:
 - 버전관리	: 1.0
 ----------------------------------------------------------
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">
                <spring:message code="TEXT.OBSTACLE.ROUTESET.SUBTITLE_EXCEL.ROUTESET_DETAIL"/>
            </h4>
        </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-md-2 control-label">
                                <spring:message code="TEXT.OBSTACLE.ROUTESET.DETAIL.EXCEL.FILE_SEL"/>
                            </label>
                            <div class="col-md-10">
        ...
        $("#btnSubmit").on('click', function (event) {
            ...
            Pace.track(function () {
                ...
                $.ajax({
                    ...
                    url: '${CONTEXT_PATH}/obstacle/routeset/routesetexcelpop.pop?actionID=ACTION_ROUTESET_EXCEL_UPLOAD_OK',
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
