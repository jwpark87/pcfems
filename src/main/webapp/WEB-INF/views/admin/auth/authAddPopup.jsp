<%----------------------------------------------------------------------------------------
 - 파일이름	:	admin/auth/authAddPopup.jsp
 - 설    명	:	권한 레벨 팝업 화면
 - 추가내용     :
 - 버전관리
 ----------------------------------------------------------
            ...
            <div class="view">
                ...
                <table class="newBox">
                    <tr>
                        ...
                        <td>
                            <input type="text" id="pop_auth_code" name="pop_auth_code" class="validate[required,maxSize[30]]">
                        </td>
                    </tr>
                    <tr>
                        <!-- 권한명 - 한글 -->
                        ...
                        <td>
                            <input type="text" id="pop_auth_nm_kor" name="pop_auth_nm_kor" class="validate[required,maxSize[50]]">
                        </td>
                    </tr>
                    <tr>
                        <!-- 권한명 - 영어-->
                        ...
                        <td>
                            <input type="text" id="pop_auth_nm_eng" name="pop_auth_nm_eng" class="validate[required,maxSize[50]]">
                        </td>
                    </tr>
                    <tr>
                        <!-- 권한명 - 일어-->
                        ...
                        <td>
                            <input type="text" id="pop_auth_nm_jpn" name="pop_auth_nm_jpn" class="validate[maxSize[50]]">
                        </td>
                    </tr>
                    <tr>
                        <!-- 사용여부 -->
...
<script type="text/javascript">
    ...
    $("#AUTH_SAVE_B").on("click", function () {
        var confirmMsg = '<spring:message code="MSG.CONFIRM.INSERT"/>';
        ...
        if (validateForm) {
            AotSmartAdmin.confirmBox(confirmMsg, function () {
                AotAjax.excute("${CONTEXT_PATH}/admin/auth/authPopup.do", {
                    actionID: "ACTION_AUTH_INSERT_OK",
