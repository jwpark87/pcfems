...
<aot:html title="${TITLE}" picker="YES" jqGrid="YES" chart="YES">
    ...
    <form name="myForm" method="POST" action="${CONTEXT_PATH}/stcs/qosreport.do">
                    ...
                    <header style="border-color: #ccc !important; background: #fff; color: #666;">
                        ...
                        <div class="widget-toolbar-s" style="display: none;">
                            <div class="label" style="background-color: #3bafda">
                                <spring:message code="TEXT.CHART.GRID.AVG_CALLING_JITTER"/>
                            </div>
                        </div>
                        <div class="widget-toolbar-s" style="display: none;">
                            <div class="label" style="background-color: #f6bb42">
                                <spring:message code="TEXT.CHART.GRID.AVG_CALLED_JITTER"/>
                            </div>
                        </div>
                        <div class="widget-toolbar-s" style="display: none;">
                        ...
                        <div class="widget-toolbar-s" style="display: none;">
                            <div class="label" style="background-color: #3b3f4f">
                                <spring:message code="TEXT.CHART.GRID.AVG_CALLING_RTP_PACKETS_LOST_FS1"/>
                            </div>
                        </div>
                        <div class="widget-toolbar-s" style="display: none;">
                            <div class="label" style="background-color: #dfe6e9; color: #666;">
    ...
    <script type="text/javascript">
                ...
                jQuery("#gridChartList").jqGrid(
                    {
                        ...
                        autoencode: true,
                        height: 360,
                        colNames: ["<spring:message code="TEXT.CHART.GRID.OCCUR_DT"/>",
                            /* "<spring:message code="TEXT.CHART.GRID.FROM_COUNTRY_CD_NAME"/>",
								"<spring:message code="TEXT.CHART.GRID.TO_COUNTRY_CD_NAME"/>", */
                            "<spring:message code="TEXT.CHART.GRID.ACME_SESSION_INGRESS_REALM"/>", "<spring:message code="TEXT.CHART.GRID.ACME_SESSION_EGRESS_REALM"/>",

                            "<spring:message code="TEXT.CHART.GRID.TRY_CALL_CNT"/>", "<spring:message code="TEXT.CHART.GRID.CONN_CALL_CNT"/>",
                            "<spring:message code="TEXT.CHART.GRID.COMP_CALL_CNT"/>",

                            "<spring:message code="TEXT.CHART.GRID.AVG_PDD"/>", "<spring:message code="TEXT.CHART.GRID.AVG_CALL_TIME"/>",
                            "<spring:message code="TEXT.CHART.GRID.AVG_CALLING_JITTER"/>", "<spring:message code="TEXT.CHART.GRID.AVG_CALLED_JITTER"/>",
                            "<spring:message code="TEXT.CHART.GRID.AVG_CALLING_R_FACTOR"/>", "<spring:message code="TEXT.CHART.GRID.AVG_CALLED_R_FACTOR"/>",
                            "<spring:message code="TEXT.CHART.GRID.AVG_CALLING_RTP_PACKETS_LOST_FS1"/>", "<spring:message code="TEXT.CHART.GRID.AVG_CALLED_RTP_PACKETS_LOST_FS1"/>",
                        ...
                        colModel: [{
                            ...
                            {
                                name: "ingress_realm_name",
                                index: "ingress_realm_name",
                                align: "left",
                                width: 150,
                                formatter: setNameText
                            }, {
                                name: "egress_realm_name",
                                index: "egress_realm_name",
                                align: "left",
                                width: 150,
                                formatter: setNameText
                            },
...

                            {
                                ...
                                name: "avg_calling_jitter",
                                index: "avg_calling_jitter",
                                align: "right",
                                formatter: AotJqGrid.formatterCurrencyDefaultValue,
                                unformat: AotJqGrid.unformatterCurrencyDefaultValue,
                                width: 150
                            }, {
                                name: "avg_called_jitter",
                                index: "avg_called_jitter",
                                align: "right",
                                formatter: AotJqGrid.formatterCurrencyDefaultValue,
                                unformat: AotJqGrid.unformatterCurrencyDefaultValue,
                                width: 150
                            }, {
                                name: "avg_calling_r_factor",
                                index: "avg_calling_r_factor",
                                align: "right",
                                formatter: AotJqGrid.formatterCurrencyDefaultValue,
                                unformat: AotJqGrid.unformatterCurrencyDefaultValue,
                                width: 150
                            }, {
                                name: "avg_called_r_factor",
                                index: "avg_called_r_factor",
                                align: "right",
                                formatter: AotJqGrid.formatterCurrencyDefaultValue,
                                unformat: AotJqGrid.unformatterCurrencyDefaultValue,
                                width: 150
                            }, {
                                name: "avg_calling_rtp_packets_lost_fs1",
                                index: "avg_calling_rtp_packets_lost_fs1",
                                align: "right",
                                formatter: AotJqGrid.formatterCurrencyDefaultValue,
                                unformat: AotJqGrid.unformatterCurrencyDefaultValue,
                                width: 150
                            }, {
                                name: "avg_called_rtp_packets_lost_fs1",
                                index: "avg_called_rtp_packets_lost_fs1",
                                align: "right",
                                formatter: AotJqGrid.formatterCurrencyDefaultValue,
                                unformat: AotJqGrid.unformatterCurrencyDefaultValue,
                                width: 150
        ...
        function goChartList() {
            ...
            jQuery("#gridChartList").setGridParam({
                url: "${CONTEXT_PATH}/stcs/qosreport.do?v=" + moment().valueOf(),
                postData: {
                    actionID: "ACTION_QOS_LIST",
        ...
        function ajaxCallChart() {
            ...
            Pace.track(function () {
                ...
                $.ajax({
                    ...
                    async: false,
                    global: false,
                    url: "${CONTEXT_PATH}/stcs/qosreport.do",
                    success: function (response) {
                        //차트 선 색 지정  //진파랑          연녹              청녹			주황			보라		연빨			검정			회색
                        var colors = ["#4a89dc", "#70ca63", "#3bafda", "#f6bb42", "#967adc", "#e9573f", "#3b3f4f", "#dfe6e9"];
                        //최소값, 최대값
                        //var xaxis_min;
                        //결과 리스트
        ...
        function doExcel() {
            ...
            AotCommon.submitFormPOST('${CONTEXT_PATH}/stcs/qosreport.do', param);
        }
    </script>
    </body>
</aot:html>
