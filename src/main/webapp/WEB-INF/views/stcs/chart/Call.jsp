...
<aot:html title="${TITLE}" picker="YES" jqGrid="YES" chart="YES">
    ...
    <form name="myForm" method="POST" action="${CONTEXT_PATH}/stcs/chart/call.do">
            ...
            <div id="content">
                ...
                <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0">
                    <header style="border-color: #ccc !important; background: #fff; color: #666;">
                        ...
                        <h2><spring:message code="TEXT.CHART.CHART.TITLE"/></h2> --%>
                        <!-- 위젯 뱃지로 범례 꾸미기 -->
                        <div class="widget-toolbar-s" style="display: none;">
                            <div class="label" style="background-color: #967adc">
                                <spring:message code="TEXT.CHART.GRID.TRY_CALL_CNT"/>
                            </div>
                        </div>
                        <div class="widget-toolbar-s" style="display: none;">
                            <div class="label" style="background-color: #3bafda">
                                <spring:message code="TEXT.CHART.GRID.CONN_CALL_CNT"/>
                            </div>
                        </div>
                        <div class="widget-toolbar-s" style="display: none;">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            jQuery("#gridChartList").jqGrid({
                <%-- url: "${CONTEXT_PATH}/stcs/chart/call.do",
                postData: {
                    actionID: "ACTION_CALL_LIST"
                ...
                colModel: [
                    ...
                    {name: "ingress_realm_name", index: "ingress_realm_name", align: "left", width: 300, formatter: setNameText},
                    {name: "egress_realm_name", index: "egress_realm_name", align: "left", width: 300, formatter: setNameText},
                    ...
                    {name: "percent_comp_call", index: "percent_comp_call", align: "right", width: 200},
        ...
        function goChartList() {
            ...
            jQuery("#gridChartList").setGridParam({
                url: "${CONTEXT_PATH}/stcs/chart/call.do?v=" + moment().valueOf(),
                postData: {
                    actionID: "ACTION_CALL_LIST"
                    , srch_date_from: $("#srch_input_date_from").val().replace(/-/gi, "") + $("#srch_input_hh_from").val() + $("#srch_input_mm_from").val()
                    , srch_date_to: $("#srch_input_date_to").val().replace(/-/gi, "") + $("#srch_input_hh_to").val() + $("#srch_input_mm_to").val()
...
//그래프 데이타 취득		
            ...
            Pace.track(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        //차트 선 색 지정
                        var colors = ["#967adc", "#3bafda", "#e9573f"];
                        //최소값, 최대값
                        //var xaxis_min;
                        //결과 리스트
        ...
        function doExcel() {
            ...
            AotCommon.submitFormPOST('${CONTEXT_PATH}/stcs/chart/call.do', param);
        }
