...
<aot:html title="${TITLE}" picker="YES" jqGrid="YES">
    ...
    <form name="myForm" method="POST" action="${CONTEXT_PATH}/stcs/realmstatistic.do">
                            ...
                            <div class="smart-form">
                                <fieldset style="background-color: #fbfbfb; padding: 0px;">
                                    ...
                                    <div class="row" style="padding-top: 10px;">
                                        ...
                                        <div class="col col-1 input-group" style="height: 32px;">
                                            <label class="input-group-addon" style="background-color: #fbfbfb; border: none;">
                                                <spring:message code="TEXT.CHART.REALM.SEARCH.ORIGIN"/>
                                                -
                                        ...
                                        <div class="col col-1 input-group" style="height: 32px;">
                                            <label class="input-group-addon" style="background-color: #fbfbfb; border: none;">
                                                <spring:message code="TEXT.CHART.REALM.SEARCH.ORIGIN"/>
                                                -
                                                <spring:message code="TEXT.CHART.REALM.SEARCH.CARRIER_NM"/>
                                            </label>
                                        </div>
                                        <div class="col col-2 input-group">
                                            <label class="input">
                                                <input type="text" name="srch_carrier_nm" id="srch_carrier_nm">
                                            </label>
                                        </div>
                                    ...
                                    <div class="row" style="padding-top: 10px;">
                                        ...
                                        <div class="col col-1 input-group" style="height: 32px;">
                                            <label class="input-group-addon" style="background-color: #fbfbfb; border: none;">
                                                <spring:message code="TEXT.CHART.REALM.SEARCH.DESTINATION"/>
                                                -
                                                <spring:message code="TEXT.CHART.SEARCH.COUNTRY_NM"/>
                                            </label>
                                        </div>
                                        ...
                                        <div class="col col-2 input-group">
                                            <label class="input">
                                                <input type="text" name="srch_dst_carrier_nm" id="srch_dst_carrier_nm">
                                            </label>
                                        </div>
                                        <div class="col col-1 input-group" style="height: 32px;">
                                            <label class="input-group-addon" style="background-color: #fbfbfb; border: none;">
    ...
    <script type="text/javascript">
                ...
                jQuery("#gridChartList").jqGrid(
                    {
                        ...
                        autoencode: true,
                        height: 360,
                        colNames: ["<spring:message code="TEXT.CHART.GRID.OCCUR_DT"/>", "<spring:message code="TEXT.CHART.REALM.GRID.LOCALITY"/>",

                            "<spring:message code="TEXT.CHART.REALM.GRID.COUNTRY_NM"/>", "<spring:message code="TEXT.CHART.REALM.GRID.CARRIER_NM"/>",
                            "<spring:message code="TEXT.CHART.REALM.GRID.ROUTING_PEER"/>", "<spring:message code="TEXT.CHART.REALM.GRID.REALM"/>",

                            "<spring:message code="TEXT.CHART.REALM.GRID.COUNTRY_NM"/>", "<spring:message code="TEXT.CHART.REALM.GRID.CARRIER_NM"/>",
                            "<spring:message code="TEXT.CHART.REALM.GRID.ROUTING_PEER"/>", "<spring:message code="TEXT.CHART.REALM.GRID.REALM"/>",

                            "<spring:message code="TEXT.CHART.REALM.GRID.IN_OCCUR_CNT"/>", "<spring:message code="TEXT.CHART.REALM.GRID.IN_TPS"/>",
                            "<spring:message code="TEXT.CHART.REALM.GRID.IN_PKT_SIZE"/>", "<spring:message code="TEXT.CHART.REALM.GRID.IN_SUCC_CNT"/>",
                            "<spring:message code="TEXT.CHART.REALM.GRID.IN_FAIL_CNT"/>", "<spring:message code="TEXT.CHART.REALM.GRID.IN_SUCC_PERCENT"/>",
                            "<spring:message code="TEXT.CHART.REALM.GRID.IN_FAIL_PERCENT"/>", "<spring:message code="TEXT.CHART.REALM.GRID.OUT_OCCUR_CNT"/>",
                            "<spring:message code="TEXT.CHART.REALM.GRID.OUT_TPS"/>", "<spring:message code="TEXT.CHART.REALM.GRID.OUT_PKT_SIZE"/>",
                            "<spring:message code="TEXT.CHART.REALM.GRID.OUT_SUCC_CNT"/>", "<spring:message code="TEXT.CHART.REALM.GRID.OUT_FAIL_CNT"/>",
                            "<spring:message code="TEXT.CHART.REALM.GRID.OUT_SUCC_PERCENT"/>", "<spring:message code="TEXT.CHART.REALM.GRID.OUT_FAIL_PERCENT"/>"],
                        colModel: [{
                            name: "occur_dt",
                            index: "occur_dt",
                            align: "center",
...

                            {
                                ...
                                name: "dst_routing_peer",
                                index: "dst_routing_peer",
                                align: "center",
                                width: 150,
                                formatter: setNameText
                            }, {
                ...
                jQuery("#gridChartList").jqGrid('setGroupHeaders', {
                    ...
                    groupHeaders: [

                        {
                            ...
                            numberOfColumns: 4,
                            titleText: '<center><b><spring:message code ='TEXT.CHART.REALM.GRID.ORIGIN'/></center>'
                        }, {
                            startColumnName: 'dst_country_nm',
                            numberOfColumns: 4,
                            titleText: '<center><b><spring:message code ='TEXT.CHART.REALM.GRID.DESTINATION'/></center>'
                        }, {
                            startColumnName: 'in_occur_cnt',
                            numberOfColumns: 7,
                            titleText: '<center><b><spring:message code ='TEXT.CHART.REALM.GRID.IN'/></center>'
                        }, {
                            startColumnName: 'out_occur_cnt',
                            numberOfColumns: 7,
                            titleText: '<center><b><spring:message code ='TEXT.CHART.REALM.GRID.OUT'/></center>'
                        }]
                });
        ...
        function bindClickEvent() {
            ...
            $("#srch_dst_carrier_nm").on('keydown', function (key) {
                if (key.keyCode === 13) {
                    goChartList();
                }
            });
        ...
        function goChartList() {
            ...
            jQuery("#gridChartList").setGridParam({
                url: "${CONTEXT_PATH}/stcs/realmstatistic.do?v=" + moment().valueOf(),
                postData: {
                    ...
                    srch_dst_carrier_nm: $("#srch_dst_carrier_nm").val(),
        ...
        function doExcel() {
            ...
            AotCommon.submitFormPOST('${CONTEXT_PATH}/stcs/realmstatistic.do', param);
        }
    </script>
    </body>
</aot:html>
