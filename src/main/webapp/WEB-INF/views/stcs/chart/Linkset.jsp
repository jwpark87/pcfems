...
<aot:html title="${TITLE}" picker="YES" jqGrid="YES">
    ...
    <form name="myForm" method="POST" action="${CONTEXT_PATH}/stcs/linksetstatistic.do">
                            ...
                            <div class="smart-form">
                                <fieldset style="background-color: #fbfbfb; padding: 0px;">
                                    ...
                                    <div class="row" style="padding-top: 10px;">
                                        ...
                                        <div class="col col-1 input-group" style="height: 32px;">
                                            <label class="input-group-addon" style="background-color: #fbfbfb; border: none;">
                                                <spring:message code="TEXT.CHART.LINKSET.SEARCH.LOCALITY"/>
                                            </label>
                                        </div>
                                        <div class="col col-2 input-group">
                                        ...
                                        <div class="col col-1 input-group" style="height: 32px;">
                                            <label class="input-group-addon" style="background-color: #fbfbfb; border: none;">
                                                <spring:message code="TEXT.CHART.LINKSET.SEARCH.COUNTRY_NM"/>
                                            </label>
                                        </div>
                                        <div class="col col-2 input-group">
                                            <label class="input">
                                        ...
                                        <div class="col col-1 input-group" style="height: 32px;">
                                            <label class="input-group-addon" style="background-color: #fbfbfb; border: none;">
                                                <spring:message code="TEXT.CHART.LINKSET.SEARCH.LINKSET"/>
                                            </label>
                                        </div>
                                        <div class="col col-2 input-group">
                                            <label class="input">
                                                <input type="text" name="srch_linkset" id="srch_linkset">
                                            </label>
                                        </div>
                                    ...
                                    <div class="row" style="padding-top: 10px;">
                                        ...
                                        <div class="col col-1 input-group" style="height: 32px;">
                                            <label class="input-group-addon" style="background-color: #fbfbfb; border: none;">
                                                <spring:message code="TEXT.CHART.LINKSET.SEARCH.CLLI"/>
                                            </label>
                                        </div>
                                        <div class="col col-2 input-group">
                                            <label class="input">
                                                <input type="text" name="srch_clli" id="srch_clli">
                                            </label>
                                        </div>
    ...
    <script type="text/javascript">
            ...
            function () {
                ...
                jQuery("#gridChartList").jqGrid(
                    {
                        ...
                        autoencode: true,
                        height: 360,
                        colNames: ["<spring:message code="TEXT.CHART.GRID.OCCUR_DT"/>", "<spring:message code="TEXT.CHART.LINKSET.GRID.LOCALITY"/>",
                            "<spring:message code="TEXT.CHART.LINKSET.GRID.LINKSET"/>", "<spring:message code="TEXT.CHART.LINKSET.GRID.COUNTRY_NM"/>",
                            "<spring:message code="TEXT.CHART.LINKSET.GRID.CARRIER_NM"/>", "<spring:message code="TEXT.CHART.LINKSET.GRID.CLLI"/>",

                            "<spring:message code="TEXT.CHART.LINKSET.GRID.IN_OCCUR_CNT"/>", "<spring:message code="TEXT.CHART.LINKSET.GRID.IN_PKT_SIZE"/>",
                            "<spring:message code="TEXT.CHART.LINKSET.GRID.IN_MAP_OCCUR_CNT"/>", "<spring:message code="TEXT.CHART.LINKSET.GRID.IN_MAP_PKT_SIZE"/>",

                            "<spring:message code="TEXT.CHART.LINKSET.GRID.OUT_OCCUR_CNT"/>", "<spring:message code="TEXT.CHART.LINKSET.GRID.OUT_PKT_SIZE"/>",
                            "<spring:message code="TEXT.CHART.LINKSET.GRID.OUT_MAP_OCCUR_CNT"/>", "<spring:message code="TEXT.CHART.LINKSET.GRID.OUT_MAP_PKT_SIZE"/>"
                        ...
                        colModel: [{
...

                            {
                                ...
                                name: "in_map_occur_cnt",
                                index: "in_map_occur_cnt",
                                align: "right",
                                width: 150,
                                formatter: AotJqGrid.formatterCurrencyDefaultValue,
                                unformat: AotJqGrid.unformatterCurrencyDefaultValue
                            }, {
                                name: "in_map_pkt_size",
                                index: "in_map_pkt_size",
                                align: "right",
                                width: 150,
                                formatter: AotJqGrid.formatterCurrencyDefaultValue,
                                unformat: AotJqGrid.unformatterCurrencyDefaultValue
...

                            {
                                ...
                                name: "out_map_occur_cnt",
                                index: "out_map_occur_cnt",
                                align: "right",
                                width: 150,
                                formatter: AotJqGrid.formatterCurrencyDefaultValue,
                                unformat: AotJqGrid.unformatterCurrencyDefaultValue
                            }, {
                                name: "out_map_pkt_size",
                                index: "out_map_pkt_size",
                                align: "right",
                                width: 150,
                                formatter: AotJqGrid.formatterCurrencyDefaultValue,
                                unformat: AotJqGrid.unformatterCurrencyDefaultValue
                ...
                jQuery("#gridChartList").jqGrid('setGroupHeaders', {
                    ...
                    groupHeaders: [{
                        ...
                        numberOfColumns: 4,
                        titleText: '<center><b><spring:message code ='TEXT.CHART.LINKSET.GRID.IN'/></center>'
                    }, {
                        startColumnName: 'out_occur_cnt',
                        numberOfColumns: 4,
                        titleText: '<center><b><spring:message code ='TEXT.CHART.LINKSET.GRID.OUT'/></center>'
                    }]
                });
        ...
        function bindClickEvent() {
            ...
            $("#srch_linkset").on('keydown', function (key) {
                if (key.keyCode === 13) {
                    goChartList();
                }
            });
        ...
        function goChartList() {
            ...
            jQuery("#gridChartList").setGridParam({
                url: "${CONTEXT_PATH}/stcs/linksetstatistic.do?v=" + moment().valueOf(),
                postData: {
        ...
        function doExcel() {
            ...
            AotCommon.submitFormPOST('${CONTEXT_PATH}/stcs/linksetstatistic.do', param);
        }
    </script>
    </body>
</aot:html>
