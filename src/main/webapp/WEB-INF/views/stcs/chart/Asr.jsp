...
<aot:html title="${TITLE}" picker="YES" jqGrid="YES" chart="YES">
    ...
    <form name="myForm" method="POST" action="${CONTEXT_PATH}/stcs/asrreport.do">
                    ...
                    <header style="border-color: #ccc !important; background: #fff; color: #666;">
                        ...
                        <div class="widget-toolbar-s" style="display: none;">
                            <div class="label" style="background-color: #4a89dc">
                                <spring:message code="TEXT.CHART.GRID.AVG_USE_TIME"/>
                            </div>
                        </div>
                        <div class="widget-toolbar-s" style="display: none;">
                        ...
                        <div class="widget-toolbar-s" style="display: none;">
                            <div class="label" style="background-color: #3bafda">
                                <spring:message code="TEXT.CHART.GRID.AVG_CALLING_R_FACTOR"/>
                            </div>
                        </div>
                        <div class="widget-toolbar-s" style="display: none;">
                            <div class="label" style="background-color: #f6bb42">
                                <spring:message code="TEXT.CHART.GRID.AVG_CALLED_R_FACTOR"/>
                            </div>
                        </div>
                        <div class="widget-toolbar-s" style="display: none;">
                            <div class="label" style="background-color: #967adc">
                                <spring:message code="TEXT.CHART.GRID.AVG_CALLING_RTP_PACKETS_LOST_FS1"/>
                            </div>
                        </div>
                        <div class="widget-toolbar-s" style="display: none;">
                            <div class="label" style="background-color: #e9573f">
                                <spring:message code="TEXT.CHART.GRID.AVG_CALLED_RTP_PACKETS_LOST_FS1"/>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            jQuery("#gridChartList").jqGrid({
				...
				"<spring:message code="TEXT.CHART.GRID.TO_COUNTRY_CD_NAME"/>", */
                    ...
                    "<spring:message code="TEXT.CHART.GRID.NOT_COMP_CALL_CNT"/>",
                    "<spring:message code="TEXT.CHART.GRID.COMP_CALL_CNT"/>",
                    "<spring:message code="TEXT.CHART.GRID.PERCENT_COMP_CALL"/>",
                    "<spring:message code="TEXT.CHART.GRID.AVG_USE_TIME"/>",
                    "<spring:message code="TEXT.CHART.GRID.AVG_PDD"/>",
                    "<spring:message code="TEXT.CHART.GRID.AVG_CALLING_R_FACTOR"/>",
                    "<spring:message code="TEXT.CHART.GRID.AVG_CALLED_R_FACTOR"/>",
                ...
                colModel: [
                    ...
                    /* {name:"from_country_cd_name"				,index:"from_country_cd_name"				,align:"left"  	,width:150, formatter:setNameText},
                    {name:"to_country_cd_name"					,index:"to_country_cd_name"					,align:"left"  	,width:150, formatter:setNameText}, */
                    {name: "ingress_realm_name", index: "ingress_realm_name", align: "left", width: 150, formatter: setNameText},
                    {name: "egress_realm_name", index: "egress_realm_name", align: "left", width: 150, formatter: setNameText},
                    {
                        name: "try_call_cnt", index: "try_call_cnt", align: "right", width: 150, formatter: AotJqGrid.formatterCurrencyDefaultValue,
                        unformat: AotJqGrid.unformatterCurrencyDefaultValue
                    },
                    {
                        name: "not_comp_call_cnt", index: "not_comp_call_cnt", align: "right", width: 150, formatter: AotJqGrid.formatterCurrencyDefaultValue,
                        unformat: AotJqGrid.unformatterCurrencyDefaultValue
                    },
                    {
                        name: "comp_call_cnt", index: "comp_call_cnt", align: "right", width: 150, formatter: AotJqGrid.formatterCurrencyDefaultValue,
                        unformat: AotJqGrid.unformatterCurrencyDefaultValue
                    },
                    {name: "percent_comp_call", index: "percent_comp_call", align: "right", width: 150},
                    {name: "avg_use_time", index: "avg_use_time", align: "right", width: 150},
                    {name: "avg_pdd", index: "avg_pdd", align: "right", width: 150},
                    {name: "avg_calling_r_factor", index: "avg_calling_r_factor", align: "right", width: 150},
                    {name: "avg_called_r_factor", index: "avg_called_r_factor", align: "right", width: 150},
                    {name: "avg_calling_rtp_packets_lost_fs1", index: "avg_calling_rtp_packets_lost_fs1", align: "right", width: 150},
                    {name: "avg_called_rtp_packets_lost_fs1", index: "avg_called_rtp_packets_lost_fs1", align: "right", width: 150},
                    /* {name:"acme_calling_packets_fs1"			,index:"acme_calling_packets_fs1"			,align:"right"  	,width:150, formatter : AotJqGrid.formatterCurrencyDefaultValue,
                      unformat : AotJqGrid.unformatterCurrencyDefaultValue},
                    {name:"acme_calling_octets_fs1"				,index:"acme_calling_octets_fs1"				,align:"right"  	,width:150, formatter : AotJqGrid.formatterCurrencyDefaultValue,
                          unformat : AotJqGrid.unformatterCurrencyDefaultValue},
                    {name:"acme_called_packets_fs1"				,index:"acme_called_packets_fs1"			,align:"right"  	,width:150, formatter : AotJqGrid.formatterCurrencyDefaultValue,
                              unformat : AotJqGrid.unformatterCurrencyDefaultValue},
                    {name:"acme_called_octets_fs1"				,index:"acme_called_octets_fs1"				,align:"right"  	,width:150, formatter : AotJqGrid.formatterCurrencyDefaultValue,
                                  unformat : AotJqGrid.unformatterCurrencyDefaultValue} */
                ],
                sortname: "occur_dt",
                rowNum: 100,
        ...
        function goChartList() {
            ...
            jQuery("#gridChartList").setGridParam({
                url: "${CONTEXT_PATH}/stcs/asrreport.do?v=" + moment().valueOf(),
                postData: {
                    actionID: "ACTION_ASR_LIST"
                    , srch_date_from: $("#srch_input_date_from").val().replace(/-/gi, "") + $("#srch_input_hh_from").val() + $("#srch_input_mm_from").val()
                    , srch_date_to: $("#srch_input_date_to").val().replace(/-/gi, "") + $("#srch_input_hh_to").val() + $("#srch_input_mm_to").val()
...
//그래프 데이타 취득		
            ...
            Pace.track(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        //결과 리스트 복사 사용. 아래에서 날짜 부분을 유닉스 타임으로 변경하면서 날짜 형식에 데이타가 변경되어버림. 최소,최대값 구하기 위해 일단 날짜만 가지고 getTime()해야해서 날짜형식 유지해야함.
                        //var tmp_result_extend = $.extend(true, [], JSON.parse(response));
                        if (result.length > 0) {
                            var val_max = 0;
                            var val_min = "";
                            ...
                            for (var y = 0; y < result.length; y++) {
                                ...
                                for (var s = 0; s < sub_list.length; s++) {
                                    ...
                                    /* if(new Date(sub_list[s][0]).getTime() > val_max){
                                        val_max = new Date(sub_list[s][0]).getTime();
                                    } */
                                }
                            }

                            //복사한 배열로 최소값 구하기. 위에서 배열이 변형되어 버림.
                            /* 	for(var ex=0;ex<tmp_result_extend.length;ex++){
                            var sub = tmp_result_extend[ex];
                            for(var su=0;su<sub.length;su++){
                                xaxis_min = sub[0][0];
                                         xaxis_min = xaxis_min.substr(0,10);
                            }
                                } */
        ...
        function chart_draw(p_datas, p_colors, p_x_min, p_x_max, tick_size, time_format) {
            ...
            /* $.plot(".chart3",
                    [{
                        "data": [
                            [new Date("2018-02-04T02:00Z").getTime(), 1068],
                            [new Date("2018-02-05T03:00Z").getTime(), 32116],
                            [new Date("2018-02-05T04:00Z").getTime(), 32202],
                            [new Date("2018-02-06T05:00Z").getTime(), 32255]
                        ],
                        "points": {
                            "show": true,
                            "radius": 5
                    ...
                    {
                        "data": [
                            [new Date("2018-02-04T02:00:00Z").getTime(), 5],
                            [new Date("2018-02-05T01:00:00Z").getTime(), 25455],
                            [new Date("2018-02-05T02:00:00Z").getTime(), 11111],
                            [new Date("2018-02-06T06:00:00Z").getTime(), 322222]
                        ],
                        "points": {
                            "show": true,
                            "radius": 5
        ...
        function doExcel() {
            ...
            AotCommon.submitFormPOST('${CONTEXT_PATH}/stcs/asrreport.do', param);
        }
