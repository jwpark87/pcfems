...
public class AotMaskingUtils {
    private AotMaskingUtils() {
    ...
    public static String getEmail(final String email) {
        ...
        final String dirty = AotEscapeUtils.unescapeAll(email);
    ...
    public static String getId(final String id) {
        ...
        final String dirty = AotEscapeUtils.unescapeAll(id);
        final StringBuilder returnValue = new StringBuilder();
    ...
    public static String getMobileTel(final String mobile) {
        ...
        final StringBuilder returnValue = new StringBuilder();
        final String dirty = StringUtils.substring(RegExUtils.removeAll(AotEscapeUtils.unescapeAll(mobile), "-"), 0, 11);
    ...
    public static String getName(final String name) {
        ...
        final String dirty = AotEscapeUtils.unescapeAll(name);
        final StringBuilder returnValue = new StringBuilder();
