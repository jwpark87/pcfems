...
public class AotEscapeUtils {
    // private static final Logger LOGGER = LoggerFactory.getLogger(AotFilterUtil.class);
    private static final XssSaxFilter XSS_SAX_FILTER = XssSaxFilter.getInstance("aot-lucy-xss-sax.xml", true);
