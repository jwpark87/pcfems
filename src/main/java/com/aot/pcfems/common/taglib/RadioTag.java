/*****************************************************************************
 * 프로그램명  : RadioTag.java
 * 설     명  : Radio 태그라이브러리 설정
 * 참고  사항  : 없음
 *****************************************************************************
 * Date       Author  Version Description
 * ---------- ------- ------- -----------------------------------------------
 * 2008.10.20  LYS      1.0    초기작성
 *****************************************************************************/
...
public class RadioTag extends TagSupport {
    private transient static final long serialVersionUID = 5223732316966563331L;
    private static final Logger LOGGER = LoggerFactory.getLogger(RadioTag.class);
    /**
     * 셀렉트박스명칭프로퍼티
     */
    private String name = "";
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            final StringBuffer sbRadio = new StringBuffer();
            ...
            if (CommonCode.YES.equals(this.init)) {
                if ("BEFORE".equals(this.place)) {
                    ...
                    if (CommonCode.YES.equals(this.inline)) {
                        sbRadio.append("<label class=\"radio\">");
                    } else {
                        sbRadio.append("<div class=\"col\">");
                        sbRadio.append("<label class=\"radio\">");
                    }

                    sbRadio.append("<input type=\"radio\" name=\"");
                    sbRadio.append(this.name);
                    sbRadio.append("\" ");
                    if (!"".equals(this.id)) {
                        sbRadio.append("id=\"");
                        sbRadio.append(this.id);
                    }
                    sbRadio.append("\" value=\"");
                    sbRadio.append(this.initCode);
                    sbRadio.append("\" ");
                    if (this.checked.equals(this.initCode)) {
                        sbRadio.append("checked ");
                    }
                    sbRadio.append(this.getCommonString());
                    sbRadio.append("<i></i>");
                    sbRadio.append(this.initName);
                    sbRadio.append("&nbsp;&nbsp;");
                    sbRadio.append(this.format);

                    // 인라인 뷰
                    if (CommonCode.YES.equals(this.inline)) {
                        sbRadio.append("</label>");
                    } else {
                        sbRadio.append("</label>");
                        sbRadio.append("</div>");
                    }
            ...
            if (this.list != null) {
                ...
                for (int i = 0; i < this.list.size(); i++) {
                    ...
                    sbRadio.append("\" value=\"");
                    sbRadio.append(codeInfo.getCode());
                    sbRadio.append("\" ");
                    ...
                    sbRadio.append(this.getCommonString());
                    sbRadio.append("<i></i>");
                    sbRadio.append(codeInfo.getCodeName());
                    sbRadio.append("&nbsp;&nbsp;");
    ...
    private String getCommonString() {
        ...
        sbRadio.append(this.event);
        sbRadio.append(" ");
        if (!"".equals(this.cssId)) {
            sbRadio.append("class=\"");
            sbRadio.append(this.cssId);
            sbRadio.append("\" ");
        }
        if (!"".equals(this.style)) {
            sbRadio.append("style=\"");
            sbRadio.append(this.style);
            sbRadio.append("\" ");
        }
        sbRadio.append(this.option);
        sbRadio.append(">");
