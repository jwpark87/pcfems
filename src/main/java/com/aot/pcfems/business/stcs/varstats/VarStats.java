 ...
 * @version 1.0
 */
public class VarStats implements Serializable {
    private transient static final long serialVersionUID = 2606922814892803906L;
    /**
     * 테이블
     */
    ...
    private Integer hfixed_left_col_cnt;
    ...
    public Integer getHfixed_left_col_cnt() {
        return this.hfixed_left_col_cnt;
    }

    public void setHfixed_left_col_cnt(final Integer hfixed_left_col_cnt) {
        this.hfixed_left_col_cnt = hfixed_left_col_cnt;
    }
}
