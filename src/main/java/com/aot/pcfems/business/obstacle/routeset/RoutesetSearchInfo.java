 ...
 * @version 1.0
 */
public class RoutesetSearchInfo extends JqGridVO implements Serializable {
    private static final long serialVersionUID = -7760609263444156491L;
    /**
     * 사용자 언어
     */
